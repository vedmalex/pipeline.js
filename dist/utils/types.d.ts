...
export type CallbackFunction = (() => void) | ((err?: unknown) => void) | ((err?: unknown, res?: unknown) => void);
export type CallbackExternalFunction<T> = (() => void) | ((err?: Possible<Error>) => void) | ((err?: Possible<Error>, res?: T) => void);
export declare function isCallback<T>(inp?: unknown): inp is CallbackFunction;
...
export type Rescue<T> = Func1Async<T, Error> | Func1Sync<T | Promise<T> | Thanable<T>, Error> | Func2Async<T, Possible<ComplexError>, Possible<T>> | Func2Sync<T | Promise<T> | Thanable<T>, Error, Possible<T>> | Func3Sync<void, Error, Possible<T>, CallbackFunction>;
...
export type EnsureFunction<T> = Func1Sync<T | Promise<T> | Thanable<T>, T> | Func1Async<T, T> | Func2Sync<void, T, CallbackFunction>;
...
export type StageRun<T extends StageObject> = (err: Possible<ComplexError>, context: ContextType<T>, callback: CallbackFunction) => void;
export type InternalStageRun<T extends StageObject> = (err: Possible<ComplexError>, context: ContextType<T>, callback: CallbackFunction) => void;
...
export declare function getPipelinConfig<T extends StageObject, R extends StageObject, C extends PipelineConfig<T>>(config: AllowedPipeline<T, R>): C;
...
export declare function isAnyStage<T extends StageObject, R extends StageObject = T>(obj: unknown): obj is AnyStage<T, R>;
