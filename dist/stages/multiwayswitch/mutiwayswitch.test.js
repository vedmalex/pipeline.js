...
describe('MWS', function () {
    ...
    it('must enter in each pipe works in parallel', function (done) {
        ...
        sw.execute(ctx, function (err, ctx) {
            expect(ctx === null || ctx === void 0 ? void 0 : ctx.size).toEqual(4);
            done();
        });
    });
    it('exception errors for', function (done) {
        ...
        sw.execute(Context.ensure({
            size: 0,
        }), function (err, ctx) {
            expect(ctx === null || ctx === void 0 ? void 0 : ctx.size).toBe(2);
    ...
    it('rescue work as expected 1 ', function (done) {
        ...
        sw.execute(Context.ensure({
            ...
            expect(ctx === null || ctx === void 0 ? void 0 : ctx.size).toBe(4);
    ...
    it('empty split run combine', function (done) {
        ...
        stage.execute({}, function (err, context) {
            expect(context === null || context === void 0 ? void 0 : context.combine).toBe(true);
            done();
        });
    });
...
//# sourceMappingURL=mutiwayswitch.test.js.map