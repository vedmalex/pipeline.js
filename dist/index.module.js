        ...
        const res = new Proxy(this, {
            ...
            set (target, key, value) {
                if (!(key in RESERVED)) {
                    ...
                    return true;
                } else if (typeof key == 'string' && key in RESERVED && RESERVED[key] != RESERVATIONS.prop) {
                    return false;
                } else {
                    target[key] = value;
                    return true;
...
export { ComplexError, Context, ContextSymbol, CreateError, DoWhile, Empty, IfElse, MultiWaySwitch, OriginalObject, Parallel, ParallelError, Pipeline, ProxySymbol, RESERVATIONS, RetryOnError, Sequential, Stage, StageSymbol, Timeout, Wrap, getEmptyConfig, getIfElseConfig, getMultWaySwitchConfig, getNameFrom, getParallelConfig, getPipelinConfig, getRetryOnErrorConfig, getStageConfig, getTimeoutConfig, getWrapConfig, isAllowedStage, isAnyStage, isCallback, isComplexError, isEnsureFunction, isExternalCallback, isMultiWaySwitch, isRescue, isRunPipelineFunction, isSingleStageFunction, isStage, isStageRun, isValidateFunction, is_async, is_async_function, is_func0, is_func0_async, is_func1, is_func1Callbacl, is_func1_async, is_func2, is_func2_async, is_func3, is_func3_async, is_thenable };
