...
describe('context', () => {
  it('create a context object as Proxy', () => {
    ...
    expect(Context.isProxy(ctx)).toBeTruthy()
  ...
  it('ensures object', () => {
    ...
    expect(Context.isProxy(ctx)).toBeTruthy()
    expect(Context.isProxy(ctx2)).toBeTruthy()
  ...
  it('fork', () => {
    ...
    expect(Context.isProxy(parent)).toBeTruthy()
  ...
  it('get', () => {
    ...
    expect(Context.isProxy(ctx2)).toBeTruthy()
    expect(Context.isProxy(ctx.address)).toBeTruthy()
