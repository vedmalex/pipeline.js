...
export type Callback2Callback<Input, Output> = (ctx: Input, done: CallbackFunction<Output>) => void
export type Callback3Callback<Input, Output> = (err: unknown, ctx: Input, done: CallbackFunction<Output>) => void
