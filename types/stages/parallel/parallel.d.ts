...
export declare class Parallel<Input, Output, T, Config extends ParallelConfig<Input, Output, T> = ParallelConfig<Input, Output, T>> extends Stage<Input, Output, Config> {
