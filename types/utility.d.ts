...
export type MergeIfDefined<TType, TWith> = UnsetMarker extends TType ? TWith : Simplify<TType & TWith>;
export type OverwriteIfDefined<TType, TWith> = UnsetMarker extends TType ? TWith : TType;
export type Simplify<TType> = {
    [K in keyof TType]: TType[K];
};
export type ExtractInput<TParams> = TParams extends WithInputParams ? TParams['_input'] : UnsetMarker;
...
export type ExtractOutput<TParams> = TParams extends WithInputOutputParams ? TParams['_output'] extends UnsetMarker ? TParams['_input'] extends UnsetMarker ? any : TParams['_input'] : TParams['_output'] : UnsetMarker;
export type InferBuilderParams<TParams extends BuilderParams> = {
    _type: TParams['_type'];
};
export type InferStageParams<TParams extends BuilderParams> = TParams extends StageParams ? {
    _type: TParams['_type'];
...
export type InferRescueParams<TParams extends BuilderParams> = TParams extends RescueParams ? {
    _type: TParams['_type'];
    _input: TParams['_input'];
    _output: TParams['_output'];
...
export type InferWrapParams<TParams extends BuilderParams> = TParams extends WrapParams ? {
    _type: TParams['_type'];
    _input: TParams['_input'];
    _output: TParams['_output'];
    _stage: TParams['_stage'];
...
export type InferTimeoutParams<TParams extends BuilderParams> = TParams extends TimeoutParams ? {
    _type: TParams['_type'];
    _input: TParams['_input'];
    _output: TParams['_output'];
    _stage: TParams['_stage'];
...
export type InferIfElseParams<TParams extends BuilderParams> = TParams extends IfElseParams ? {
    _type: TParams['_type'];
    _stage: TParams['_stage'];
    _input: TParams['_input'];
    _output: TParams['_output'];
...
export type InferRetryOnErrorParams<TParams extends BuilderParams> = TParams extends RetryOnErrorParams ? {
    _type: TParams['_type'];
    _input: TParams['_input'];
    _output: TParams['_output'];
    _stage: TParams['_stage'];
...
export type InferDoWhileParams<TParams extends BuilderParams> = TParams extends DoWhileParams ? {
    _type: TParams['_type'];
    _input: TParams['_input'];
    _output: TParams['_output'];
    _stage: TParams['_stage'];
...
export type InferPipelineParams<TParams extends BuilderParams> = TParams extends PipelineParams ? {
    _type: TParams['_type'];
    _input: TParams['_input'];
    _output: TParams['_output'];
} : {
...
export type InferSequentialParams<TParams extends BuilderParams> = TParams extends SequentialParams ? {
    _type: TParams['_type'];
    _input: TParams['_input'];
    _output: TParams['_output'];
    _stage: TParams['_stage'];
...
export type InferMultiWaySwitchParams<TParams extends BuilderParams> = TParams extends MultiWaySwitchParams ? {
    _type: TParams['_type'];
    _input: TParams['_input'];
    _output: TParams['_output'];
...
export type InferMultiWaySwitchCaseParams<TParams extends BuilderParams> = TParams extends MultiWaySwitchCaseParams ? {
    _type: TParams['_type'];
    _input: TParams['_input'];
    _output: TParams['_output'];
    _stage: TParams['_stage'];
...
export type ExtractStage<TStage> = TStage extends AbstractStage<any, any> ? TStage : UnsetMarker;
export type ExtractStageInput<TStage> = TStage extends AbstractStage<infer $Input, any> ? $Input : UnsetMarker;
...
export type GetIntellisenceFor<Stage extends keyof IntelliSence, State extends keyof IntelliSence[Stage]> = IntelliSence[Stage][State];
export type PropertiesFor<T extends StageType, kind extends 'all' | 'start'> = T extends 'stage' ? GetIntellisenceFor<T, kind> : T extends 'rescue' ? GetIntellisenceFor<T, kind> : T extends 'wrap' ? GetIntellisenceFor<T, kind> : T extends 'emtpy' ? GetIntellisenceFor<T, kind> : T extends 'timeout' ? GetIntellisenceFor<T, kind> : T extends 'ifelse' ? GetIntellisenceFor<T, kind> : T extends 'retryonerror' ? GetIntellisenceFor<T, kind> : T extends 'dowhile' ? GetIntellisenceFor<T, kind> : T extends 'sequential' ? GetIntellisenceFor<T, kind> : T extends 'multiwayswitch' ? GetIntellisenceFor<T, kind> : T extends 'multiwayswitchcase' ? GetIntellisenceFor<T, kind> : ErrorMessage<'not implemented'>;
...
export type HiddenIntellisenceFor<Stage extends StageType, Property extends keyof IntelliSence[Stage]> = Exclude<AllPropertiesFor<Stage> | Property, GetIntellisenceFor<Stage, Property>>;
export type IntellisenseFor<Stage extends StageType, Property extends keyof IntelliSence[Stage], Type> = Omit<Type, HiddenIntellisenceFor<Stage, Property>>;
