...
var Stage = (function () {
    ...
    Stage.prototype.runStageMethod = function (err_, err, ctx, context, stageToRun, callback) {
        if (err || err_) {
            var errors = [err, err_].filter(function (e) { return e instanceof Error; });
                    ...
                    try {
                        if (input_is_context) {
                            ...
                            if (context_1.Context.isContext(_ctx)) {
                                ...
                                var errors = [err, new Error('context is always context object')].filter(function (e) { return e instanceof Error; });
