...
var Stage = (function () {
    ...
    Stage.prototype.execute = function (_err, _context, _callback) {
        ...
        if (!__callback) {
                    ...
                    try {
                        if (input_is_context) {
                            ...
                            if (context_1.Context.isContext(_ctx)) {
                                ...
                                __callback((0, ErrorList_1.CreateError)([err, new Error('context is always context object')]), _ctx);
                            }
                        }
                        resolve_2();
                    }
            ...
            return (0, withTimeout_1.withTimeout)(promise, config_1.Config.timeout).catch(function (err) {
                var error = (0, ErrorList_1.CreateError)(new Error('Stage Error', {
                    cause: {
                        err: err,
                        context: context,
                        name: _this.reportName,
                        run: stageToRun,
                        original: context_1.Context.isContext(context) ? context.original : context,
                    }
                }));
