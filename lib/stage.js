    ...
    Stage.prototype.execute = function (_err, _context, _callback) {
        ...
        if (!__callback) {
            ...
            process.nextTick(function () {
                var sucess = function (ret) { return back_1(undefined, ret !== null && ret !== void 0 ? ret : context); };
                var fail = function (err) { return back_1(err, context); };
                ...
                if (err &&
                    _this._config.run &&
                    !(0, can_fix_error_1.can_fix_error)({ run: _this._config.run })) {
