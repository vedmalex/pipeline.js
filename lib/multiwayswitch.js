...
var MultiWaySwitch = (function (_super) {
    ...
    MultiWaySwitch.prototype.compile = function (rebuild) {
        ...
        var run = function (initialErr, initialCtx, done) { return __awaiter(_this, void 0, void 0, function () {
            var actuals, i_1, hasError, errors, resultContext, promises, err_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        promises = actuals.map(function (stg, index) {
                            return new Promise(function (resolve) {
                                var lctx = _this.splitCase(stg, initialCtx);
                    ...
                    case 2:
                        _a.sent();
                        if (hasError) {
                            done((0, ErrorList_1.CreateError)(errors), resultContext !== null && resultContext !== void 0 ? resultContext : initialCtx);
                        }
                        else {
