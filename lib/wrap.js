    ...
    Wrap.prototype.compile = function (rebuild) {
        ...
        var run = function (err, context, done) {
            ...
            if (_this.config.stage) {
                (0, run_or_execute_1.run_or_execute)(_this.config.stage, err, ctx !== null && ctx !== void 0 ? ctx : context, function (err, retCtx) {
                    if (!err) {
                        var result = _this.finalize(ctx, retCtx);
                        done(undefined, result !== null && result !== void 0 ? result : ctx);
                    }
                    else {
                        done(err, ctx);
                    }
