...
exports.run_callback_once = exports.getIfElseConfig = exports.getTimeoutConfig = exports.getWrapConfig = exports.getEmptyConfig = exports.getParallelConfig = exports.getPipelinConfig = exports.getNameFrom = exports.getStageConfig = exports.isAllowedStage = exports.isEnsureFunction = exports.isValidateFunction = exports.isRescue = exports.isRunPipelineFunction = exports.isSingleStageFunction = exports.is_thenable = exports.is_func3_async = exports.is_func2_async = exports.is_func1_async = exports.is_func0_async = exports.is_func3 = exports.is_func2 = exports.is_func1 = exports.is_func0 = exports.is_async = void 0;
...
function run_callback_once(wrapee) {
    ...
    const done = (err, ctx) => {
        if (done_call == 0) {
            ...
            throw ErrorList_1.CreateError([err, 'callback called more than once']);
        }
    };
    return done;
}
