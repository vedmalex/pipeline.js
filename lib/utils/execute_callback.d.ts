...
export declare function execute_callback<T extends StageObject>(err: Possible<ComplexError>, run: RunPipelineFunction<T>, context: T, _done: CallbackFunction<T>): void;
