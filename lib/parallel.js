    ...
    Parallel.prototype.compile = function (rebuild) {
        ...
        if (this.config.stage) {
            var run = function (initialErr, initialCtx, done) { return __awaiter(_this, void 0, void 0, function () {
                var children, len, promises, _loop_1, this_1, i, result, errors, result_1, err_1;
                var _this = this;
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            _loop_1 = function (i) {
                                ...
                                var _b = Promise.withResolvers(), promise = _b.promise, reject = _b.reject, resolve = _b.resolve;
                                (0, run_or_execute_1.run_or_execute)(this_1.config.stage, initialErr, child, function (err, retCtx) {
                                    if (err) {
                                        ...
                                        resolve({ index: i, ctx: retCtx !== null && retCtx !== void 0 ? retCtx : child });
                                    }
                                });
                        ...
                        case 2:
                            ...
                            if (errors.length > 0) {
                                ...
                                result_1 = this.combine(initialCtx, children);
                                done(undefined, result_1);
                            }
                            return [3, 4];
                        case 3:
                            err_1 = _a.sent();
