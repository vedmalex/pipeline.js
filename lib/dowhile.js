...
var DoWhile = (function (_super) {
    ...
    DoWhile.prototype.compile = function (rebuild) {
        ...
        var run = function (initialErr, initialContext, done) { return __awaiter(_this, void 0, void 0, function () {
            var iter, currentError, currentContext, err_1;
            var _this = this;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4, new Promise(function (resolve, reject) {
                                (0, run_or_execute_1.run_or_execute)(_this.config.stage, currentError, _this.split(currentContext, iter), function (err, ctx) {
                                    if (err) {
                                        currentError = err;
                                    }
                                    else {
