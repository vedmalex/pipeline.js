...
export interface DoWhileConfig<T extends StageObject, R extends StageObject> extends StageConfig<T, R> {
...
export declare class DoWhile<T extends StageObject, R extends StageObject = T> extends Stage<T, DoWhileConfig<T, R>, R> {
