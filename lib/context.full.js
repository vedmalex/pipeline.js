...
exports.Context = exports.RESERVATIONS = exports.ProxySymbol = exports.OriginalObject = exports.ContextSymbol = void 0;
    ...
    function Context(config) {
        ...
        var res = new Proxy(this, {
            get: function (target, key, _proxy) {
                ...
                if (!(key in RESERVED)) {
                    ...
                    if (key in target.ctx) {
                        value = target.ctx[key];
                    }
                    else {
                        value = (_a = target.__parent) === null || _a === void 0 ? void 0 : _a[key];
                    }
            ...
            ownKeys: function (target) {
                var keys = new Set();
                for (var _i = 0, _a = Reflect.ownKeys(target.ctx); _i < _a.length; _i++) {
                    var key = _a[_i];
                    keys.add(key);
                }
                if (target.__parent) {
                    for (var _b = 0, _c = Reflect.ownKeys(target.__parent); _b < _c.length; _b++) {
                        var key = _c[_b];
                        keys.add(key);
                    }
                }
...
//# sourceMappingURL=context.full.js.map